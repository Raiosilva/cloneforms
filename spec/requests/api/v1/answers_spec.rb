  ...
  describe "GET /answers" do
    ...
    describe "GET /answers/:id" do
      ...
      context "With valid authentication headers" do
        ...
        context "When answer dont exists" do
          it "returns 404" do
            get "/api/v1/answers/#{Faker::Lorem.word}", params: {}, headers: header_with_authentication(@user)
            expect_status(404)
          end
        end
      end
    ...
    describe "DELETE /answers/:id" do
      ...
      context "With valid authentication headers" do
        ...
        context "When answer dont exists" do
          it "returns 404" do
            delete "/api/v1/answers/#{Faker::Lorem.word}", params: {}, headers: header_with_authentication(@user)
            expect_status(404)
          end
        end
      end
